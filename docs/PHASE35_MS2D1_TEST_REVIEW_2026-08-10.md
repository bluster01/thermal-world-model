...
1. commit + push test 产物（18 组 metrics/episodes/ledgers + summary_test.json）。
2. 更新 TODO：D1 状态 = "validation PASS / test 未确认（CI 下界 17.2–18.8%）"。
3. D2 设计决策交 Codex（压力诊断视角重新设计，不传播 D1 阳性）。
